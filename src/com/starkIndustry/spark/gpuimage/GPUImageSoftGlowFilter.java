...
package com.starkIndustry.spark.gpuimage;
 ...
 */
public class GPUImageSoftGlowFilter extends GPUImage3x3TextureSamplingFilter {
    public static final String THREE_X_THREE_TEXTURE_SAMPLING_FRAGMENT_SHADER = "" +
            ...
            "\n" + 
            "    resultColor = vec4(((resultColor.rgb - vec3(0.5)) * 0.1 + vec3(0.2)), resultColor.w);\n" + 
            "    //resultColor = clamp(resultColor, 0.0, 1.0);\n" + 
            "    gl_FragColor = vec4(1.0) - (vec4(1.0) - centerColor) * (vec4(1.0) - resultColor);\n" +
     ...
     */
    public GPUImageSoftGlowFilter(final float[] convolutionKernel) {
